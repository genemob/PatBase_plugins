 ...
 * @author Piotr
 */
public class PatBaseFrame extends javax.swing.JFrame {
    PatBasePost parent;
     ...
     */
    public PatBaseFrame(PatBasePost patbasePost) {
        parent = patbasePost;
        initComponents();
...
//        parent.runQuery2AP(
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatBaseFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatBaseFrame(null).setVisible(true);
            }
        });
    }
